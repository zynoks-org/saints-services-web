...
export function WhyChooseUsTabs() {
  ...
  const tabContent: Record<string, TabData> = {
    ...
    professionalism: {
      ...
      imageSrc: 'https://snlwjfavn5e79gpo.public.blob.vercel-storage.com/Web/why-us.jpg'
    },
    experience: {
      id: 'experience',
      label: 'EXPERIENCE',
      ...
      imageSrc: 'https://snlwjfavn5e79gpo.public.blob.vercel-storage.com/Web/Saints-Services-Recruitment-Team.png'
    },
    reliability: {
      id: 'reliability',
      label: 'RELIABILITY',
