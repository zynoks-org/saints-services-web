...
export default function ContactPage() {
  ...
  return (
    <>
      <title>Contact Us & 24/7 Control Desk | Saints Services Ltd UK</title>
      <meta 
        name="description" 
        content="Contact Saints Services Ltd for 24/7 UK security operations, rapid emergency manned guarding response, keyholding dispatch, and commercial facilities quotes." 
      />
      <meta 
        name="keywords" 
        content="Contact Security Company UK, Emergency SIA Guarding, 24/7 Security Control Desk London, Saints Services Contact, Security Quote UK" 
      />
      <meta property="og:title" content="Contact Operational Dispatch | Saints Services Ltd" />
      <meta 
        property="og:description" 
        content="Get an immediate binding quotation or speak with our 24/7 UK control desk for SIA security guarding and facilities management." 
      />
      <meta property="og:url" content="https://saintsservices.co.uk/contact" />
          ...
          <section className="relative bg-slate-100 dark:bg-[#0b1329] text-slate-900 dark:text-white py-12 sm:py-20 lg:py-24 border-b border-slate-200 dark:border-slate-800/80 overflow-hidden transition-colors duration-300">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
              ...
              <div className="max-w-3xl">
                <Badge icon={Clock} className="mb-4 sm:mb-6">24/7 UK Emergency Control Desk</Badge>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start mb-12">
                ...
                <div className="lg:col-span-5 space-y-6">
                  <div>
                    <Badge icon={ShieldCheck} className="mb-3">Rapid Dispatch Guarantee</Badge>
                ...
                <div className="lg:col-span-7 bg-white dark:bg-[#070d1e] border border-slate-200 dark:border-slate-800 p-6 sm:p-8 rounded-md shadow-2xl relative transition-colors duration-300">
                  ...
                  <div className="relative z-10 space-y-6">
                    <div>
                      <Badge icon={Lock} className="mb-3">Direct Operations Portal</Badge>
