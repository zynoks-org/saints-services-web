            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div id="quote-form" className="lg:col-span-5 relative px-2">
                ...
                <div className="bg-[#0b1329] text-white p-6 sm:p-8 rounded-2xl sm:rounded-3xl border border-slate-800 shadow-2xl relative z-10">
                  ...
                  <p className="text-slate-400 text-xs font-medium mb-6">Get a key holding quotation within 2 hours.</p>
                  ...
                  {submitted ? (
                    ...
                    <form onSubmit={handleSubmit} className="space-y-3.5">
                      ...
                      <textarea name="enquiry" rows={3} placeholder="Property location and alarm details..." className="w-full bg-slate-900 border border-slate-800 rounded-xl px-3.5 py-3 text-xs text-white focus:outline-none focus:border-[#f59e0b] resize-none" />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
              ...
              <div className="lg:col-span-5 bg-[#0b1329] text-white p-6 sm:p-8 rounded-2xl sm:rounded-3xl border border-slate-800 shadow-xl relative overflow-hidden">
                ...
                <div className="bg-slate-900 border border-slate-800 text-white p-5 rounded-2xl mb-6 text-center">
                  ...
                  <div className="text-xl sm:text-2xl font-black uppercase tracking-tight text-white">Keyholding Benefits</div>
                </div>
