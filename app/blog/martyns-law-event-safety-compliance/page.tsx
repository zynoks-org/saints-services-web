...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: 'article',
    images: [{ url: 'https://snlwjfavn5e79gpo.public.blob.vercel-storage.com/Web/SIA-Event-Security-Officers-Implementing-Martyns-Law-Safety-Protocols.jpg', width: 1200, height: 630, alt: 'SIA Event Security Officers Managing Counter-Terrorism Protocols' }],
  },
  twitter: {
    ...
    images: ['https://snlwjfavn5e79gpo.public.blob.vercel-storage.com/Web/SIA-Event-Security-Officers-Implementing-Martyns-Law-Safety-Protocols.jpg'],
  }
};
...
const jsonLd = {
  ...
  "image": "https://snlwjfavn5e79gpo.public.blob.vercel-storage.com/Web/SIA-Event-Security-Officers-Implementing-Martyns-Law-Safety-Protocols.jpg",
  "author": { 
    "@type": "Organization", 
      ...
      <article className="flex-grow py-12 sm:py-20 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="relative h-[320px] sm:h-[460px] rounded-sm overflow-hidden border border-slate-200 dark:border-slate-800 shadow-2xl mb-12 bg-slate-900 transition-colors">
            <Image 
              src="https://snlwjfavn5e79gpo.public.blob.vercel-storage.com/Web/SIA-Event-Security-Officers-Implementing-Martyns-Law-Safety-Protocols.jpg" 
