      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="space-y-8 text-slate-700 dark:text-slate-300 text-sm sm:text-base leading-relaxed font-normal transition-colors">
          ...
          <section id="procuring-guards" className="space-y-4">
            ...
            <p>
              Partnering with an SIA-approved provider ensures that officers are cleared to <strong>BS7858 screening standards</strong>, holding valid 5-year employment verification, enhanced DBS criminal history clearance, and specialized training in gatehouse management and emergency response.
            </p>
            <p>
